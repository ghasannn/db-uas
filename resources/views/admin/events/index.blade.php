                ...
                <tr class="hover:bg-slate-50/50 transition">
                    ...
                    <td class="px-8 py-6">
                        @if($event->poster_path && \Illuminate\Support\Facades\Storage::disk('public')->exists($event->poster_path))
                            <img src="{{ asset('storage/' . $event->poster_path) }}" alt="{{ $event->title }}" class="w-16 h-20 rounded-xl object-cover shadow-sm border border-slate-100">
                        @else
                            <img src="https://placehold.co/120x150?text=No+Poster" alt="No Poster" class="w-16 h-20 rounded-xl object-cover shadow-sm border border-slate-100">
                        @endif
                    </td>
